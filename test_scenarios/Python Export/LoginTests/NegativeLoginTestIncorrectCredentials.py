...
class NegativeLoginTestIncorrectCredentials(unittest.TestCase):
    def setUp(self):
    ...
    def test_negative_login_test_incorrect_credentials(self):
        driver = self.driver
        ...
        driver.find_element_by_name("acc").send_keys("TestMember")
