...
class PositiveLoginTestSuccessful(unittest.TestCase):
    def setUp(self):
    ...
    def test_positive_login_test_successful(self):
        driver = self.driver
