...
class NegativeLoginTestNoPassword(unittest.TestCase):
    def setUp(self):
    ...
    def test_negative_login_test_no_password(self):
        driver = self.driver
