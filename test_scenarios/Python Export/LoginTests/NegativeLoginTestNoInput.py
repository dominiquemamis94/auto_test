...
class NegativeLoginTestNoInput(unittest.TestCase):
    def setUp(self):
    ...
    def test_negative_login_test_no_input(self):
        driver = self.driver
