...
class PositiveLoadStatementPage(unittest.TestCase):
    def setUp(self):
    ...
    def test_positive_load_statement_page(self):
        driver = self.driver
