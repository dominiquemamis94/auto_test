...
class PositiveLoadPromotionsTab(unittest.TestCase):
    def setUp(self):
    ...
    def test_positive_load_promotions_tab(self):
        driver = self.driver
