...
class PositiveLoadNotificationsTab(unittest.TestCase):
    def setUp(self):
    ...
    def test_positive_load_notifications_tab(self):
        driver = self.driver
