...
class PositiveLoadUpdateProfileTab(unittest.TestCase):
    def setUp(self):
    ...
    def test_positive_load_update_profile_tab(self):
        driver = self.driver
