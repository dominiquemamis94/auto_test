...
class PositiveLoadMyProfileTab(unittest.TestCase):
    def setUp(self):
    ...
    def test_positive_load_my_profile_tab(self):
        driver = self.driver
